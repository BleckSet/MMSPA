...
?>
    ...
    <div class="container">
        <h2 class="bg">Варианты доставки и оплаты</h2>
...
<h5>
    ...
    Варианты доставки:
            ...
            <img src="img/dest/delivery.jpg" alt="">
        </div>
    </div>
</section>
   ...
   <section class="impressum">
    <div class="container">
        ...
        <div class="impressum_inner">
            <p>Vertretungsberechtigte Person: <br>
                Matthias Pop (Geschäftsführer)</p>
            <p>Als Kleinunternehmer im Sinne von <br> § 19 Abs. 1 UStG wird <br> Umsatzsteuer nicht berechnet.</p>
            <p>
                Die Inhalte dieser Website unterliegen dem deutschen Urheberrecht. Eine <br> Vervielfältigung, Bearbeitung, Verbreitung oder sonstige Nutzung bedarf <br> der schriftlichen Zustimmung von DEINTUB.
            </p>
